			...
			<div className="w-full px-10 py-6 bg-white rounded-3xl sm:max-w-fit h-3/4">
				...
				<div className="">
					<div >
						...
						/>
						{/* 버튼에 투명도 적용 방법?? */}
						<button className="w-1/5 p-1 text-base text-lg font-semibold text-white rounded-full bg-opacity-30 bg-gradient-to-r from-sky-600 to-teal-300"
					...
					<div className="flex justify-center ">
						...
						<Link href="/user/SignIn" className="pl-2 font-semibold text-sky-600">
							Login
						</Link>
					</div>
				</div>
