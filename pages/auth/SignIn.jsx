        ...
        C464,288.704,448.328,333.792,421.832,370.584z" />
                ...
                <div className="px-10 py-6 bg-opacity-0 md:pl-8 rounded-2xl">
                    <div className="flex mx-1 my-8 border-b-2 border-sky-400 md:mx-2 hover:border-purple-300">
                        <label className="self-center text-gray-700 w-28" >Nickname :</label>
                        <input className="w-full py-3 pl-2 bg-transparent border-0 placeholder-slate-400 focus:placeholder-transparent md:pl-6 focus:outline-none" type="text" name="nickName" placeholder="닉네임을 입력하세요" onChange={ChangeNickName} autoComplete="on" required />
                    </div>
