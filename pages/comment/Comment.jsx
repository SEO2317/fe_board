...
const Comment = (props) => {
	...
	const updateComment = async () => {
		...
		.then((resp) => {
			...
			console.log("[Comment.jsx] updateComment() success :D");
			...
			console.log("[Comment.jsx] updateComment() error :<");
			console.log(err);
	...
	const deleteComment = async () => {
		await axios.delete(`http://localhost:3000/comment/${comment.seq}`)
			.then((resp) => {
				console.log("[BoardComment.jsx] deleteComment() success :D");
				console.log(resp.data);
				...
				console.log("[BoardComment.jsx] deleteComment() error :<");
				console.log(err);
			});
	}
				...
				<div className="my-1 d-flex justify-content-center">
					...
					<div className="col-4 d-flex justify-content-end">
					{
						...
						(localStorage.getItem("nickName") == comment.nickName) ?
							<>
								<button className="btn btn-outline-secondary" onClick={updateToggle}><i className="fas fa-edit"></i> Modify</button> &nbsp; 
								<button className="btn btn-outline-danger" onClick={deleteComment}><i className="fas fa-trash-alt"></i> Delete</button>
...

				{
					...
					show ?
						<>
							...
							<div className="my-1 d-flex justify-content-center">
								<button className="btn btn-dark" onClick={updateComment}><i className="fas fa-edit"></i> Success </button>
							</div>
						</>
					:
						<>
